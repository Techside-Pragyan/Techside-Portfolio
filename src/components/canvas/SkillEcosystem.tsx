...
const skillsData = [
  { id: 1, name: 'Python', color: '#3b82f6', icon: <SiPython size={24} />, prof: '98%', exp: '1+ Years', projects: '15+' },
  { id: 2, name: 'TensorFlow', color: '#f59e0b', icon: <SiTensorflow size={24} />, prof: '92%', exp: '1+ Years', projects: '8+' },
  { id: 3, name: 'PyTorch', color: '#ef4444', icon: <SiPytorch size={24} />, prof: '90%', exp: '1+ Years', projects: '5+' },
  { id: 4, name: 'Scikit-Learn', color: '#f97316', icon: <SiScikitlearn size={24} />, prof: '95%', exp: '1+ Years', projects: '10+' },
  { id: 5, name: 'Pandas', color: '#8b5cf6', icon: <SiPandas size={24} />, prof: '96%', exp: '1+ Years', projects: '20+' },
  { id: 6, name: 'NumPy', color: '#0ea5e9', icon: <SiNumpy size={24} />, prof: '95%', exp: '1+ Years', projects: '20+' },
  { id: 7, name: 'OpenCV', color: '#10b981', icon: <SiOpencv size={24} />, prof: '85%', exp: '1+ Years', projects: '6+' },
  { id: 8, name: 'LangChain', color: '#d946ef', icon: <Blocks size={24} />, prof: '88%', exp: '1+ Years', projects: '4+' },
  { id: 9, name: 'FastAPI', color: '#14b8a6', icon: <SiFastapi size={24} />, prof: '92%', exp: '1+ Years', projects: '7+' },
  { id: 10, name: 'SQL', color: '#3b82f6', icon: <SiPostgresql size={24} />, prof: '95%', exp: '1+ Years', projects: '12+' },
  { id: 11, name: 'Docker', color: '#0ea5e9', icon: <SiDocker size={24} />, prof: '85%', exp: '1+ Years', projects: '5+' },
  { id: 12, name: 'Git', color: '#f43f5e', icon: <SiGit size={24} />, prof: '98%', exp: '1+ Years', projects: 'All' },
  { id: 13, name: 'GitHub', color: '#ffffff', icon: <SiGithub size={24} />, prof: '98%', exp: '1+ Years', projects: 'All' },
  { id: 14, name: 'Linux', color: '#eab308', icon: <SiLinux size={24} />, prof: '90%', exp: '1+ Years', projects: 'All' },
  { id: 15, name: 'Machine Learning', color: '#10b981', icon: <BrainCircuit size={24} />, prof: '95%', exp: '1+ Years', projects: '10+' },
  { id: 16, name: 'Deep Learning', color: '#ec4899', icon: <Cpu size={24} />, prof: '90%', exp: '1+ Years', projects: '6+' },
  { id: 17, name: 'NLP', color: '#8b5cf6', icon: <Bot size={24} />, prof: '88%', exp: '1+ Years', projects: '4+' },
];
